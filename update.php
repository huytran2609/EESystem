...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
               <p>Mật khẩu cũ</p>
               <input type="password" name="old_pass" placeholder="Nhập mật khẩu cũ của bạn" maxlength="50" class="box">
               <p>Mật khẩu mới</p>
               <input type="password" name="new_pass" placeholder="Nhập mật khẩu mới của bạn" maxlength="50" class="box">
               <p>Xác nhận mật khẩu</p>
               <input type="password" name="cpass" placeholder="Xác nhận mật khẩu mới của bạn" maxlength="50" class="box">
         </div>
      </div>
