...
<section class="video-form">
   ...
   <h1 class="heading">Cập nhật bài giảng</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Cập nhật trạng thái <span>*</span></p>
      ...
      <input type="text" name="title" maxlength="100" required placeholder="Nhập tiêu đề bài giảng" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>Cập nhật mô tả<span>*</span></p>
      <textarea name="description" class="box" required placeholder="Nhập mô tả bài giảng" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>Cập nhật khóa học</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--Chọn bài giảng</option>
         <?php
      ...
      <p>Cập nhật hình thu nhỏ</p>
      <input type="file" name="thumb" accept="image/*" class="box">
      <video src="../uploaded_files/<?= $fecth_videos['video']; ?>" controls></video>
      <p>Cập nhật bài giảng</p>
      <input type="file" name="video" accept="video/*" class="box">
      <input type="submit" value="Cập nhật bài giảng" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">Xem bài giảng</a>
         <input type="submit" value="Xóa bài giảng" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">Không tìm thấy bài giảng! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
