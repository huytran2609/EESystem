...
<section class="video-form">
   ...
   <h1 class="heading">Đăng tải thêm văn bản vào vectordb</h1>

   <form action="" method="post" enctype="multipart/form-data">
      <p>Danh sách namespace <span>*</span></p>
      <select name="playlist" class="box" required>
         <option value="" disabled selected>--Chọn namespace</option>
         <?php
         ...
         ?>
         <option value="<?= $fetch_playlist['id']; ?>"><?= $fetch_playlist['namespace']; ?></option>
         <?php
            }
         ?>
         <?php
      ...
      <p>Chọn file txt <span>*</span></p>
      <input type="file" name="thumb" accept="image/*" required class="box box-txt">
      <input type="submit" value="Tải văn bản" name="submit" class="btn">
   </form>
